...
func TestCommentHandler(t *testing.T) {
	...
	var testBody2 = []byte(`{"newsID": 35,"content": "Тест qwerty "}`)
	var testBody3 = []byte(`{"newsID": 35,"content": "Тест йцукен "}`)
	var testBody4 = []byte(`{"newsID": 35,"content": "Тест zxvbnm "}`)
	...
	// Проверяем обращение к handler-у с словами из стоплиста
